const { User, Customer, Manager } = require('../model');
const bcrypt = require('bcrypt');
const UserDto = require('../dtos/user-dto');
const crypto = require('crypto');
const tokenService = require('./../service/token-service');
const { sendEmail } = require("../service/emailConfig");
    ...
    try {
      ...
      if (error) {
        ...
        sendEmail({
          to: email,
          subject: "Registr",
          html: `<p>Hello dear ${name}</p><a href="${url}">Click</a>`,
        });
